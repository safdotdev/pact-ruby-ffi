...
RSpec.describe 'pactffi_new_plugin spec - calculateMulti' do
  ...
  xdescribe 'with grpcInteraction - calculateMulti' do
    ...
    before do
      ...
      PactRubyFfi.pactffi_logger_attach_sink('stderr', PactRubyFfi::FfiLogLevelFilter['LOG_LEVEL_TRACE'])
...
RSpec.describe 'pactffi_new_plugin spec - calculateOne' do
  # unskip so this test runs, it will fail verification correctly on the provider side (method not implemented)
