...
# PactFfi::Logger.log_to_buffer(5)
# # PactFfi::Logger::message('pact-ruby-fiddle', 'INFO', "hello from ffi version:")
# PactFfi::Logger::log_to_file('file.log',5)
# PactFfi::Logger::message('pact-ruby-fiddle', 'INFO', "hello from ffi version:")
verifier = PactFfi::Verifier::new()
PactFfi::Verifier::add_file_source(verifier,'./pacts/a-b.json')
